...
class Form(QMainWindow):
    def __init__(self, parent = None):
        ...
        # self.setWindowIcon(QIcon('icons8-captain-america-16.png'))
        self.setWindowIcon(QIcon('coder.jpg'))
        ...
        button.setToolTip('This is start button')
        button.move(10, 70)
    ...
    def getDirectory(self):  # <-----
        ...
        self.plainTextEdit.appendHtml(
            "<br>Выбрали папку: <b>{}</b>".format(dirlist))
    ...
    def saveFile(self):
        filename, ok = QFileDialog.getSaveFileName(self,
                                                   ...
                                                   "All Files(*.*)")
        self.plainTextEdit.appendHtml(
            "<br>Сохранить файл: <b>{}</b> <br> <b>{:*^54}</b>"
            "".format(filename, ok))
